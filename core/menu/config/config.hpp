...
public:
	...
	float skelecolor[4] = { 1.0f,1.0f,1.0f,1.0f };
	float hostageclr[4] = { 1.0f,1.0f,1.0f,1.0f };
	float clr_sky[4] = { 1.0f,1.0f,1.0f,1.0f };
	float projek_clr[4] = { 1.0f,1.0f,1.0f,1.0f };
	float clr_box[4] = { 1.0f,1.0f,1.0f,1.0f };
	float clr_health[4] = { 1.0f,1.0f,1.0f,1.0f };
	float clr_name[4] = { 1.0f,1.0f,1.0f,1.0f };
	float clr_weapon[4] = { 1.0f,1.0f,1.0f,1.0f };
	float sync_colors[4] = { 1.0f,1.0f,1.0f,1.0f };
	float clr_footstep[4] = { 1.0f,1.0f,1.0f,1.0f };
	int clr_menu1[3] = { 7, 196, 127 };
	float clr_menu2[4] = { 5 / 255.f, 139 / 255.f, 90 / 255.f };
	float clr_main[4] = { 1.0f,1.0f,1.0f,1.0f };
	bool chams = false;
