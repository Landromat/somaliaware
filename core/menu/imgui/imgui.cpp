...
ImGuiStyle::ImGuiStyle() {
	...
	Colors[ImGuiCol_FrameBg] = ImVec4(60 / 255.f, 60 / 255., 60 / 255., 1.f);   // Background of checkbox, radio button, plot, slider, text input
	Colors[ImGuiCol_FrameBgHovered] = ImVec4(60 / 255.f, 60 / 255., 60 / 255., 1.f);
	Colors[ImGuiCol_FrameBgActive] = ImVec4(65 / 255.f, 65 / 255., 65 / 255., 1.f);
	...
	Colors[ImGuiCol_ComboBg] = ImVec4(60 / 255.f, 60 / 255., 60 / 255., 1.f);
	Colors[ImGuiCol_CheckMark] = ImVec4(0.90f, 0.90f, 0.90f, 0.50f);
	Colors[ImGuiCol_SliderGrab] = ImVec4(1.00f, 1.00f, 1.00f, 0.30f);
	Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.80f, 0.50f, 0.50f, 1.00f);
	Colors[ImGuiCol_Button] = ImVec4(60 / 255.f, 60 / 255., 60 / 255., 1.f);
	Colors[ImGuiCol_ButtonHovered] = ImVec4(65 / 255.f, 65 / 255., 65 / 255., 1.f);
	Colors[ImGuiCol_ButtonActive] = ImVec4(80 / 255.f, 80 / 255., 80 / 255., 1.f);
...
bool ImGui::Checkbox(const char* label, bool* v) {
	...
	window->DrawList->AddRectFilledMultiColor(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), GetColorU32(ImVec4(71 / 255.f, 71 / 255.f, 71 / 255.f, 1.0f)), GetColorU32(ImVec4(71 / 255.f, 71 / 255.f, 71 / 255.f, 1.0f)), GetColorU32(ImVec4(51 / 255.f, 51 / 255.f, 51 / 255.f, 1.f)), GetColorU32(ImVec4(51 / 255.f, 51 / 255.f, 51 / 255.f, 1.f)));
